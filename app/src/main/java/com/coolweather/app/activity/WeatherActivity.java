...
public class WeatherActivity extends Activity implements OnClickListener{
	...
	private void showWeather() {
		...
		ImageView weather = (ImageView) findViewById(R.id.weather_img);
		RelativeLayout back = (RelativeLayout) findViewById(R.id.back);
		String weatherString = prefs.getString("weather_desp", "");
		if(weatherString.contains("雨")){
			weather.setImageResource(R.drawable.yu);
			back.setBackgroundColor(this.getResources().getColor(R.color.yu));
		}else if(weatherString.contains("阴")){
			weather.setImageResource(R.drawable.yin);
			back.setBackgroundColor(this.getResources().getColor(R.color.yin));
		}else if(weatherString.contains("多云")){
			weather.setImageResource(R.drawable.duoyun);
			back.setBackgroundColor(this.getResources().getColor(R.color.duoyun));
		}else if(weatherString.contains("雪")){
			weather.setImageResource(R.drawable.xue);
			back.setBackgroundColor(this.getResources().getColor(R.color.xue));
		}else{
			weather.setImageResource(R.drawable.qing);
			back.setBackgroundColor(this.getResources().getColor(R.color.qing));
		}
		temp1Text.setText(prefs.getString("temp1", ""));
		temp2Text.setText(prefs.getString("temp2", ""));
		weatherDespText.setText(weatherString);
		publishText.setText("" + prefs.getString("publish_time", "") + "发布");
		currentDateText.setText(prefs.getString("current_date", ""));
		fengxiang.setText(prefs.getString("fengxiang", "") + " ");
		fengli.setText(prefs.getString("fengli", ""));
